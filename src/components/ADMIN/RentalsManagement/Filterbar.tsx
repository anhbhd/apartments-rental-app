...
const cssBase =
  "inline-flex whitespace-nowrap border-b-2 border-transparent py-2 px-3 text-sm font-medium text-gray-600 transition-all duration-200 ease-in-out hover:border-b-blue-600 hover:text-blue-600 ";
const active =
  "inline-flex whitespace-nowrap border-b-2 border-transparent border-b-blue-600 py-2 px-3 text-sm font-semibold text-blue-600 transition-all duration-200 ease-in-out";
